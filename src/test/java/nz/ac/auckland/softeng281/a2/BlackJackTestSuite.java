...
public class BlackJackTestSuite {
    ...
    public static class YourTests {
        ...
        public void testExampleAssignment() {
            // lost 50
            HandFactory.addHand(players.get(0), 100, new Card(Card.Rank.EIGHT, Card.Suit.CLUBS),
                    new Card(Card.Rank.TEN, Card.Suit.CLUBS), new Card(Card.Rank.TEN, Card.Suit.HEARTS));
            HandFactory.addHand(players.get(1), 90, new Card(Card.Rank.EIGHT, Card.Suit.CLUBS),
                    new Card(Card.Rank.TEN, Card.Suit.CLUBS), new Card(Card.Rank.TEN, Card.Suit.HEARTS));
            HandFactory.addHand(players.get(2), 50, new Card(Card.Rank.EIGHT, Card.Suit.CLUBS),
                    new Card(Card.Rank.TEN, Card.Suit.CLUBS), new Card(Card.Rank.TEN, Card.Suit.HEARTS));
            HandFactory.addHand(dealer, 10, new Card(Card.Rank.TEN, Card.Suit.DIAMONDS),
                    new Card(Card.Rank.TEN, Card.Suit.CLUBS), new Card(Card.Rank.TEN, Card.Suit.HEARTS));
            game.checkWinner();
            System.out.println("rgeigbe");
            game.printPlayerHighestGain();
        }
